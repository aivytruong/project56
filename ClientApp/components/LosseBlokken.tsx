...
export class LosseBlokken extends React.Component<RouteComponentProps<{}>> {
    ...
    public render() {
        return <div>
            ...
            <div className="categories">
            <NavLink to={ '/product' }  activeClassName='active'> <button><img src="https://www.parentmap.com/images/article/6670/kids-with-lego.jpg" width={300} height={200}/></button> </NavLink>
            <br/>

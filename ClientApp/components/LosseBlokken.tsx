...
export class LosseBlokken extends React.Component<RouteComponentProps<{}>> {
    ...
    public render() {
        return <div>
            ...
            <br/>
            <NavLink to={ '/StarwarsLosseBlokken' }  activeClassName='active'> <button>Seperate figures</button> </NavLink>     
            </div>
            ...
            <br/>
            <NavLink to={ '/product' }  activeClassName='active'> <button>Seperate bricks</button> </NavLink>     
            </div> 
            ...
            <br/>
            <NavLink to={ '/product' }  activeClassName='active'> <button>Seperate objects</button> </NavLink>     
            </div> 
            ...
            <br/>
            <NavLink to={ '/KidsSets' }  activeClassName='active'> <button>Seperate decorations</button> </NavLink>     
            </div> 

...
export class KidsProductPage3 extends React.Component<RouteComponentProps<{}>> {
    constructor() {
        super();
        this.state = {};
    ...
    public render() {
        return <div>
            <br/>
            <h2>Starwars</h2>
            <img src="http://brickdave.com/wp-content/uploads/2016/11/61cCsKgbXL.jpg" width={600} height={300}/>
            <br/>
            <br/>

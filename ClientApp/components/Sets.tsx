...
export class Sets extends React.Component<RouteComponentProps<{}>> {
    ...
    public render() {
        return <div>
            ...
            <br/>
            <NavLink to={ '/NinjagoSets' }  activeClassName='active'> <Button className="hoii" bsStyle="red" bsSize="small">LEGO NINJAGO</Button> </NavLink>     
            </div>
            ...
            <br/>
            <NavLink to={ '/StarwarsSets' }  activeClassName='active'> <Button className="hoii" bsStyle="red" bsSize="small">LEGO STARWARS</Button> </NavLink>     
            </div> 
            ...
            <br/>
            <NavLink to={ '/LegoCitySets' }  activeClassName='active'> <Button className="hoii" bsStyle="red" bsSize="small">LEGO CITY</Button> </NavLink>     
            </div> 
            ...
            <br/>
            <NavLink to={ '/DuploSets' }  activeClassName='active'> <Button className="hoii" bsStyle="red" bsSize="small">LEGO KIDS</Button> </NavLink>     
            </div> 
            ...
            <br/>
            <NavLink to={ '/AdvancedModelsSets' }  activeClassName='active'> <Button className="hoii" bsStyle="red" bsSize="small">ADVANCED MODELS</Button> </NavLink>     
            </div> 
            ...
            <br/>
            <NavLink to={ '/CastleSets' }  activeClassName='active'> <Button className="hoii" bsStyle="red" bsSize="small">CASTLE</Button> </NavLink>     
            </div> 
            ...
            <br/>
            <NavLink to={ '/PiratesSets' }  activeClassName='active'> <Button className="hoii" bsStyle="red" bsSize="small">PIRATES</Button> </NavLink>     
            </div> 
            ...
            <br/>
            <NavLink to={ '/HarryPotterSets' }  activeClassName='active'> <Button className="hoii" bsStyle="red" bsSize="small">HARRY POTTER</Button> </NavLink>     
            </div> 
            ...
            <br/>
            <NavLink to={ '/ArchitectureSets' }  activeClassName='active'> <Button className="hoii" bsStyle="red" bsSize="small">ARCHITECTURE</Button> </NavLink>     
            </div> 
            ...
            <br/>
            <NavLink to={ '/LordOfTheRingsSets' }  activeClassName='active'> <Button className="hoii" bsStyle="red" bsSize="small">The Lord of the Rings</Button> </NavLink>     
            </div>
            ...
            <br/>
            <NavLink to={ '/MinecraftSets' }  activeClassName='active'> <Button className="hoii" bsStyle="red" bsSize="small">Minecraft</Button> </NavLink>     
            </div>
            ...
            <br/>
            <NavLink to={ '/MonsterFightsSets' }  activeClassName='active'> <Button className="hoii" bsStyle="red" bsSize="small">Monster Fighters</Button> </NavLink>     
            </div>
            ...
            <br/>
            <NavLink to={ '/ClassicSets' }  activeClassName='active'> <Button className="hoii" bsStyle="red" bsSize="small">Classic</Button> </NavLink>     
            </div>
            ...
            <br/>
            <NavLink to={ '/DCCSHSets' }  activeClassName='active'> <Button className="hoii" bsStyle="red" bsSize="small">DC Comics Super Heroes</Button> </NavLink>     
            </div>
            ...
            <br/>
            <NavLink to={ '/SeriousPlaySets' }  activeClassName='active'> <Button className="hoii" bsStyle="red" bsSize="small">Serious Play (business)</Button> </NavLink>     
            </div>
            ...
            <br/>
            <NavLink to={ '/EducationSets' }  activeClassName='active'> <Button className="hoii" bsStyle="red" bsSize="small">Education</Button> </NavLink>     
            </div>
            ...
            <br/>
            <NavLink to={ '/BionicleSets' }  activeClassName='active'> <Button className="hoii" bsStyle="red" bsSize="small">Bionicle</Button> </NavLink>     
            </div>
            ...
            <br/>
            <NavLink to={ '/HeroFactorySets' }  activeClassName='active'> <Button className="hoii" bsStyle="red" bsSize="small">HERO Factory</Button> </NavLink>     
            </div>
            ...
            <br/>
            <NavLink to={ '/FusionSets' }  activeClassName='active'> <Button className="hoii" bsStyle="red" bsSize="small">Fusion</Button> </NavLink>     
            </div>
            ...
            <br/>
            <NavLink to={ '/AtlantisSets' }  activeClassName='active'> <Button className="hoii" bsStyle="red" bsSize="small">Atlantis</Button> </NavLink>     
            </div>
            ...
            <br/>
            <NavLink to={ '/FriendsLegoSets' }  activeClassName='active'> <Button className="hoii" bsStyle="red" bsSize="small">Friends</Button> </NavLink>     
            </div>
            ...
            <br/>
            <NavLink to={ '/MSHSets' }  activeClassName='active'> <Button className="hoii" bsStyle="red" bsSize="small">Marvel Super Heroes</Button> </NavLink>     
            </div>
            ...
            <br/>
            <NavLink to={ '/SpaceSets' }  activeClassName='active'> <Button className="hoii" bsStyle="red" bsSize="small">Space</Button> </NavLink>     
            </div>
            ...
            <br/>
            <NavLink to={ '/PromotionalSets' }  activeClassName='active'> <Button className="hoii" bsStyle="red" bsSize="small">Promotional</Button> </NavLink>     
            </div>   
            ...
            <br/>
            <NavLink to={ '/SeasonalSets' }  activeClassName='active'> <Button className="hoii" bsStyle="red" bsSize="small">Seasonal</Button> </NavLink>     
            </div>
            ...
            <br/>
            <NavLink to={ '/GamesSets' }  activeClassName='active'> <Button className="hoii" bsStyle="red" bsSize="small">Games</Button> </NavLink>     
            </div>
            ...
            <br/>
            <NavLink to={ '/ElvesSets' }  activeClassName='active'> <Button className="hoii" bsStyle="red" bsSize="small">Elves</Button> </NavLink>     
            </div>
            ...
            <br/>
            <NavLink to={ '/MixelsSets' }  activeClassName='active'> <Button className="hoii" bsStyle="red" bsSize="small">Mixels</Button> </NavLink>     
            </div>
            ...
            <br/>
            <NavLink to={ '/DinoSets' }  activeClassName='active'> <Button className="hoii" bsStyle="red" bsSize="small">Dino</Button> </NavLink>     
            </div>
            ...
            <br/>
            <NavLink to={ '/TheSimpsonsSets' }  activeClassName='active'> <Button className="hoii" bsStyle="red" bsSize="small">The Simpsons</Button> </NavLink>     
            </div>
            ...
            <br/>
            <NavLink to={ '/PharaohsQuestSets' }  activeClassName='active'> <Button className="hoii" bsStyle="red" bsSize="small">The Pharaoh's Quest</Button> </NavLink>     
            </div> 
            ...
            <br/>
            <NavLink to={ '/JurassicWorldSets' }  activeClassName='active'> <Button className="hoii" bsStyle="red" bsSize="small">Jurassic World</Button> </NavLink>     
            </div> 
            ...
            <br/>
            <NavLink to={ '/PowerMinersSets' }  activeClassName='active'> <Button className="hoii" bsStyle="red" bsSize="small">Power Miners</Button> </NavLink>     
            </div>   
            </div>                                                                                     
    </div>
